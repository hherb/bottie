...
use crate::{
    ...
    inference::{
        ...
        ChatRequest, ProviderError, ProviderErrorCode, StreamSink, Usage,
    },
...
#[cfg(test)]
use crate::inference::{OllamaToolCall, OllamaToolResult, OpenAiToolCall, OpenAiToolResult};
...
#[cfg(test)]
pub(crate) use openai::execute_openai_tool_round_async;
pub(crate) use openai::stream_openai_tools;

...
// The exact transport is intentionally dormant until the next slice can download and persist
// generated bytes without exposing temporary provider URLs across IPC.
#[allow(dead_code)]
...
use image_generation::{
    DashScopeQwenImageProvider, ImageGenerationProvider, QWEN_IMAGE_PROVIDER_ID,

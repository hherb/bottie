...
>
  ...
  {:else if name === "brain"}
    <path
      d="M9.5 4.5A2.5 2.5 0 0 0 7 7v.2A3 3 0 0 0 5 10a3 3 0 0 0 1.2 2.4A3.5 3.5 0 0 0 9.5 17H10V5.5a1 1 0 0 0-.5-1Z"
    />
    <path
      d="M14.5 4.5A2.5 2.5 0 0 1 17 7v.2a3 3 0 0 1 2 2.8 3 3 0 0 1-1.2 2.4 3.5 3.5 0 0 1-3.3 4.6H14V5.5a1 1 0 0 1 .5-1Z"
    />
    <path
  ...
  {:else if name === "new-chat"}
    <path d="M12 20H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h10" />
    <path d="M16 3h5v5M21 3l-9 9" />
  {:else if name === "paperclip"}
    <path d="m20.5 11.5-8.7 8.7a5 5 0 0 1-7.1-7.1l9.4-9.4a3.5 3.5 0 0 1 5 5l-9.4 9.4a2 2 0 1 1-2.8-2.8l8.6-8.6" />
  {:else if name === "panel"}

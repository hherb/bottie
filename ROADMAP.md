...
5. [ ] Present pending, completed, failed, and cancelled assistant image messages; those durable states and bounded
   previews are implemented, while open, copy, export, retry, and deletion remain to be added without reusing the
   existing user-attachment association or exposing native paths.

...
- [ ] Anthropic-shaped tool-loop integration plus visible and removable memory citations in the context panel;
...
- Anthropic Messages definition/call/result mapping and generation-loop wiring;
